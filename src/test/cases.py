...
("a*(^a)", "aa", "", "a", MATCH),
("(..)*(...)*", "a", "", "", NOMATCH, [NONE, NONE]),
("(..)*(...)*", "abcd", "", "abcd", MATCH, ["cd", NONE]),
("(ab|a)(bc|c)", "abc", "", "abc", MATCH, ["ab", "c"]),
("(ab)c|abc", "abc", "", "abc", MATCH, ["ab"]),
("a{0}b", "ab", "", "b", MATCH),
("(a*)(b?)(b+)b{3}", "aaabbbbbbb", "", "aaabbbbbbb", MATCH, ["aaa", "b", "bbb"]),
("(a*)(b{0,1})(b{1,})b{3}", "aaabbbbbbb", "", "aaabbbbbbb", MATCH, ["aaa", "b", "bbb"]),
# E a{9876543210} NULL  BADBR
("((a|a)|a)", "a", "", "a", MATCH, ["a", "a"]),
("(a*)(a|aa)", "aaaa", "", "aaaa", MATCH, ["aaa", "a"]),
("a*(a.|aa)", "aaaa", "", "aaaa", MATCH, ["aa"]),
("a(b)|c(d)|a(e)f", "aef", "", "aef", MATCH, [NONE, NONE, "e"]),
("(a|b)?.*", "b", "", "b", MATCH, ["b"]),
("(a|b)c|a(b|c)", "ac", "", "ac", MATCH, ["a", NONE]),
("(a|b)c|a(b|c)", "ab", "", "ab", MATCH, [NONE, "b"]),
("(a|b)*c|(a|ab)*c", "abc", "", "abc", MATCH, ["b", NONE]),
("(a|b)*c|(a|ab)*c", "xc", "", "c", MATCH, [NONE, NONE]),
("(.a|.b).*|.*(.a|.b)", "xa", "", "xa", MATCH, ["xa", NONE]),
("a?(ab|ba)ab", "abab", "", "abab", MATCH, ["ab"]),
("a?(ac{0}b|ba)ab", "abab", "", "abab", MATCH, ["ab"]),
("ab|abab", "abbabab", "", "ab", MATCH),
("aba|bab|bba", "baaabbbaba", "", "bba", MATCH),
("aba|bab", "baaabbbaba", "", "bab", MATCH),
("(aa|aaa)*|(a|aaaaa)", "aa", "", "aa", MATCH, ["aa", NONE]),
("(a.|.a.)*|(a|.a...)", "aa", "", "aa", MATCH, ["aa", NONE]),
("ab|a", "xabc", "", "ab", MATCH),
("ab|a", "xxabc", "", "ab", MATCH),
("(Ab|cD)*", "aBcD", "i", "aBcD", MATCH, ["cD"]),
("[^-]", "--a", "", "a", MATCH),
("[a-]*", "--a", "", "--a", MATCH),
("[a-m-]*", "--amoma--", "", "--am", MATCH),
...
("[^a]", "\n", "", "\n", MATCH),
("\na", "\na", "", "\na", MATCH),
("(a)(b)(c)", "abc", "", "abc", MATCH, ["a", "b", "c"]),
("xxx", "xxx", "", "xxx", MATCH),
("(^|[ (,;])((([Ff]eb[^ ]* *|0*2/|\* */?)0*[6-7]))([^0-9]|$)", "feb 6,", "", "feb 6,", MATCH, ["", "feb 6", "feb 6", "feb ", ","]),
("(^|[ (,;])((([Ff]eb[^ ]* *|0*2/|\* */?)0*[6-7]))([^0-9]|$)", "2/7", "", "2/7", MATCH, ["", "2/7", "2/7", "2/", ""]),
("(^|[ (,;])((([Ff]eb[^ ]* *|0*2/|\* */?)0*[6-7]))([^0-9]|$)", "feb 1,Feb 6", "", ",Feb 6", MATCH),
("((((((((((((((((((((((((((((((x))))))))))))))))))))))))))))))", "x", "", "x", MATCH),
("((((((((((((((((((((((((((((((x))))))))))))))))))))))))))))))*", "xx", "", "xx", MATCH),
("a?(ab|ba)*", "ababababababababababababababababababababababababababababababababababababababababa", "", "ababababababababababababababababababababababababababababababababababababababababa", MATCH, ["ba"]),
