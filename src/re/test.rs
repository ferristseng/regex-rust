...
//
// Last Modified: April 22 2014 12:22PM
...
", "284", Some(_), &[])
  ...
  fn test_case_ident_318() {
    run_tests!("(..)*(...)*", "abcd", ~"", ~"abcd", "318", Some(_), &[])
  }

  #[test]
  fn test_case_ident_319() {
    run_tests!("(ab|a)(bc|c)", "abc", ~"", ~"abc", "319", Some(_), &[])
  }

  #[test]
  fn test_case_ident_320() {
    run_tests!("(ab)c|abc", "abc", ~"", ~"abc", "320", Some(_), &[])
  }
  ...
  fn test_case_ident_322() {
    run_tests!("(a*)(b?)(b+)b{3}", "aaabbbbbbb", ~"", ~"aaabbbbbbb", "322", Some(_), &[])
  }

  #[test]
  fn test_case_ident_323() {
    run_tests!("(a*)(b{0,1})(b{1,})b{3}", "aaabbbbbbb", ~"", ~"aaabbbbbbb", "323", Some(_), &[])
  }

  #[test]
  fn test_case_ident_324() {
    run_tests!("((a|a)|a)", "a", ~"", ~"a", "324", Some(_), &[])
  }

  #[test]
  fn test_case_ident_325() {
    run_tests!("(a*)(a|aa)", "aaaa", ~"", ~"aaaa", "325", Some(_), &[])
  }

  #[test]
  fn test_case_ident_326() {
    run_tests!("a*(a.|aa)", "aaaa", ~"", ~"aaaa", "326", Some(_), &[])
  }

  #[test]
  fn test_case_ident_327() {
    run_tests!("a(b)|c(d)|a(e)f", "aef", ~"", ~"aef", "327", Some(_), &[])
  }

  #[test]
  fn test_case_ident_328() {
    run_tests!("(a|b)?.*", "b", ~"", ~"b", "328", Some(_), &[])
  }

  #[test]
  fn test_case_ident_329() {
    run_tests!("(a|b)c|a(b|c)", "ac", ~"", ~"ac", "329", Some(_), &[])
  }

  #[test]
  fn test_case_ident_330() {
    run_tests!("(a|b)c|a(b|c)", "ab", ~"", ~"ab", "330", Some(_), &[])
  }

  #[test]
  fn test_case_ident_331() {
    run_tests!("(a|b)*c|(a|ab)*c", "abc", ~"", ~"abc", "331", Some(_), &[])
  }

  #[test]
  fn test_case_ident_332() {
    run_tests!("(a|b)*c|(a|ab)*c", "xc", ~"", ~"c", "332", Some(_), &[])
  }

  #[test]
  fn test_case_ident_333() {
    run_tests!("(.a|.b).*|.*(.a|.b)", "xa", ~"", ~"xa", "333", Some(_), &[])
  }

  #[test]
  fn test_case_ident_334() {
    run_tests!("a?(ab|ba)ab", "abab", ~"", ~"abab", "334", Some(_), &[])
  }

  #[test]
  fn test_case_ident_335() {
    run_tests!("a?(ac{0}b|ba)ab", "abab", ~"", ~"abab", "335", Some(_), &[])
  }
  ...
  fn test_case_ident_339() {
    run_tests!("(aa|aaa)*|(a|aaaaa)", "aa", ~"", ~"aa", "339", Some(_), &[])
  }

  #[test]
  fn test_case_ident_340() {
    run_tests!("(a.|.a.)*|(a|.a...)", "aa", ~"", ~"aa", "340", Some(_), &[])
  }
  ...
  fn test_case_ident_343() {
    run_tests!("(Ab|cD)*", "aBcD", ~"", ~"aBcD", "343", Some(_), &[])
  }
...
a", "354", Some(_), &[])
  ...
  fn test_case_ident_355() {
    run_tests!("(a)(b)(c)", "abc", ~"", ~"abc", "355", Some(_), &[])
  }
  ...
  fn test_case_ident_357() {
    run_tests!("(^|[ (,;])((([Ff]eb[^ ]* *|0*2/|\\* */?)0*[6-7]))([^0-9]|$)", "feb 6,", ~"", ~"feb 6,", "357", Some(_), &[])
  }

  #[test]
  fn test_case_ident_358() {
    run_tests!("(^|[ (,;])((([Ff]eb[^ ]* *|0*2/|\\* */?)0*[6-7]))([^0-9]|$)", "2/7", ~"", ~"2/7", "358", Some(_), &[])
  }
  ...
  fn test_case_ident_362() {
    run_tests!("a?(ab|ba)*", "ababababababababababababababababababababababababababababababababababababababababa", ~"", ~"ababababababababababababababababababababababababababababababababababababababababa", "362", Some(_), &[])
  }
