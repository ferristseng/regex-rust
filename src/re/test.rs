...
//
// Last Modified: April 08 2014 11:22AM
...
mod python_tests {
  ...
  fn test_case_ident_156() {
    run_tests!("\\x54", "T", ~"T", "156", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_157() {
    run_tests!("\\x79", "y", ~"y", "157", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_158() {
    run_tests!("\\x00", "7", ~"", "158", None, &'static [])
  }

  #[test]
  fn test_case_ident_159() {
    run_tests!("\\x2B", "+", ~"+", "159", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_160() {
    run_tests!("\\x2b", "+", ~"+", "160", Some(_), &'static [])
  }

  #[test]
  #[should_fail]
  fn test_case_ident_161() {
    run_tests!("\\x4g", "Test", ~"", "161", None, &'static [])
  }

  #[test]
  fn test_case_ident_162() {
    run_tests!("\\x32\\x45+\\x30*", "2EEE", ~"2EEE", "162", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_163() {
    run_tests!("\\x{54}", "T", ~"T", "163", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_164() {
    run_tests!("\\x{DbB0}", "\u06f0", ~"\u06f0", "164", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_165() {
    run_tests!("\\x{54}\\x{DbB0}+\\x{36}*", "T\u06f0\u06f0\u06f0", ~"T\u06f0\u06f0\u06f0", "165", Some(_), &'static [])
  }

  #[test]
  #[should_fail]
  fn test_case_ident_166() {
    run_tests!("\\x{}", "Test", ~"", "166", None, &'static [])
  }

  #[test]
  #[should_fail]
  fn test_case_ident_167() {
    run_tests!("\\x{000}", "Test", ~"", "167", None, &'static [])
  }

  #[test]
  #[should_fail]
  fn test_case_ident_168() {
    run_tests!("\\x{00000000}", "Test", ~"", "168", None, &'static [])
  }

  #[test]
  fn test_case_ident_169() {
    run_tests!("\\61", "1", ~"1", "169", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_170() {
    run_tests!("\\061", "1", ~"1", "170", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_171() {
    run_tests!("\\175", "}", ~"}", "171", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_172() {
    run_tests!("\\615", "15", ~"15", "172", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_173() {
    run_tests!("\\615", "1", ~"1", "173", None, &'static [])
  }

  #[test]
  fn test_case_ident_174() {
    run_tests!("\\77\\123+\\111*", "?SSSSS", ~"?SSSSS", "174", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_175() {
    run_tests!("\\v", "", ~"", "175", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_176() {
    run_tests!("\\f", "", ~"", "176", Some(_), &'static [])
  }
...
", "177", Some(_), &'static [])
  ...
  fn test_case_ident_181() {
    run_tests!("\\T", "	", ~"	", "181", None, &'static [])
  }

  #[test]
  fn test_case_ident_182() {
    run_tests!("\\QThis is the string!\\E", "This is the string!", ~"This is the string!", "182", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_183() {
    run_tests!("\\Q((a)*)*\\E", "((a)*)*", ~"((a)*)*", "183", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_184() {
    run_tests!("(\\Q({[\\E)*", "({[({[({[({[({[", ~"({[({[({[({[({[", "184", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_185() {
    run_tests!("\\Q\\E", "", ~"", "185", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_186() {
    run_tests!("a*b", "abaabaaab", ~"ab", "186", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_187() {
    run_tests!("(ab)+", "abbbbbbbab", ~"ab", "187", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_custom_1() {
