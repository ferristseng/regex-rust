...
//
// Last Modified: April 07 2014 10:47PM
...
mod python_tests {
  ...
  fn test_case_ident_159() {
    run_tests!("\\x32\\x45+\\x30*", "2EEE", ~"2EEE", "159", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_160() {
    run_tests!("a*b", "abaabaaab", ~"ab", "160", Some(_), &'static [])
  }

  #[test]
  fn test_case_ident_161() {
    run_tests!("(ab)+", "abbbbbbbab", ~"ab", "161", Some(_), &'static [])
  }
